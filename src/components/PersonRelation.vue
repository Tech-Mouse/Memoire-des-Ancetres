...
<template>
  <section v-if="toDisplay && toDisplay.length" :class="dynamicCenter">
    <div :class="dynamicFlex">
      <Link
        :href="'/person/' + oneInstance.person_id.toString()"
        v-if="toDisplay && toDisplay.length"
        class="content--info--personal"
        v-for="oneInstance in toDisplay"
      ...
      >
        ...
        <div class="flex">
          ...
          <div class="content--info--personal--dates">
            <span
              v-if="
                oneInstance.date_of_birth && oneInstance.date_of_birth.length
              "
              class="content--info--personal--dates--birth"
              >{{ oneInstance.date_of_birth }}</span
            >
          </div>
        </div>
      </Link>
